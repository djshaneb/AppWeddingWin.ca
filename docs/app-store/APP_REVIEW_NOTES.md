...
Notifications are optional and generic, without message text. Camera access is for QR scanning. Chat photo upload, microphone, and background location are disabled.

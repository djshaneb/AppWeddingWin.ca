...
Actual marketing/ad-audience use and the actual contest-sponsorship arrangement are still awaiting owner confirmation. Shared-message retention, staff privacy/report procedures, full provider collection/retention, App Privacy purposes/linkage/tracking, and complete native/payment-route coverage remain open. No policy, Apple privacy answer or app code was changed by these checks.

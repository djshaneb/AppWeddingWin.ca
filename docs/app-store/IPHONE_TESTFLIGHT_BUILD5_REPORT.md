...
Status recorded September 15, 2026, updated through the independent audit and approved Apple Developer Support submission at approximately 21:17:50 UTC. **Build 5 finished in EAS, passed archive checks, uploaded successfully and was processed and assigned to internal QA by Apple. Installation failed twice on an iPhone 15 and once on an iPhone 16 Pro with “The requested app is not available or doesn’t exist.” The newer phone was using the verified tester account; its existing development build 3 remains installed. Build 5 is installed on neither phone, and zero build 5 iPhone functional tests have run.** TestFlight preparation passes are separate from app acceptance. No App Review submission or public release has occurred.
...
The existing development app was retained. Across both phones there were **three actual build 5 installation attempts: two on iPhone 15 and one on iPhone 16 Pro**. There are no build 5 iPhone functional test results.

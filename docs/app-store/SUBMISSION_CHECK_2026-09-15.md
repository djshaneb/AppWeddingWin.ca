...
At that earlier checkpoint, the version 1.0 draft **selected build 5**. Manual release remains required. Physical installation/testing, App Privacy and remaining policy gates are open. The later diagnostic follow-up, including the HTTP 404 trace findings, was submitted and receipt-verified as **FB24795843** at 23:40 UTC, without attachments; the earlier support-case search had found only Apple’s acknowledgement. No App Review submission or public release occurred.
...
Private reviewer Notes remain saved and verified. At that earlier checkpoint, the version draft selected build 5; App Privacy, physical acceptance and remaining policy gates remain open. Apple received the diagnostic follow-up as **FB24795843** at 23:40 UTC, without attachments. No App Review submission or public release occurred.

On September 16 at 01:05:58.585875 UTC, one guarded build 7 Update on the previously working iPad (9th generation) / iPadOS 26.1 also failed with HTTP 404 at the same TestFlight install-data endpoint. The diagnostic captured an installation failure, not an app-test pass. The new iPad evidence was posted to FB24795843 and receipt-verified at 01:09 UTC on September 16 (6:09 p.m. PDT on September 15), without attachments. The underlying cause and distribution acceptance remain unresolved.

A second guarded iPad Update, after verified build 7 removal/readdition to internal QA, also failed at 01:13:41.386387 UTC with the same install-data HTTP 404 and no Open button/package progress. Two iPad attempts are now recorded, neither successful. The second result was sent to FB24795843 and receipt-verified at 01:15 UTC on September 16 (6:15 p.m. PDT on September 15), without attachments; no app code or App Review state changed.


## Current version-draft selection — September 16

The version 1.0 draft was updated to **1.0.0 (7)**, Apple build `221d5f3d-a511-4df3-be32-a982c6489743`, and saved. A full App Store Connect accessibility check after reload confirmed build 7 selected, manual release retained, Save disabled, and status **Prepare for Submission**. The evidence was recorded at **01:51:08 UTC** in `work/app-store-build7-sept15/apple-version-draft-build7-selection-private.json` (600). Earlier build 4/5 selection statements are historical. This metadata change does not resolve TestFlight delivery, final App Privacy or acceptance, and is not App Review submission or public release.

...
The version 1.0 draft **still selects build 5**. Manual release remains required. Physical installation/testing, App Privacy and remaining policy gates are open. Feedback Assistant’s final upload consent is pending, and the latest support-case search found only Apple’s acknowledgement. No App Review submission or public release occurred.
...
Private reviewer Notes remain saved and verified. The version draft still selects build 5; App Privacy, physical acceptance, remaining policy gates and the final Apple feedback-upload consent remain open. No App Review submission or public release occurred.

...
EAS submission `722bb739-c323-4de7-b5b1-b0f0e9d48105` was scheduled at 23:15 UTC. A fresh App Store Connect row shows **1.0.0 (7) Processing**, with creation time 4:15 p.m. in that UI. The upload has reached Apple; **completed processing and internal-group assignment remain unverified at this checkpoint**. At that earlier checkpoint, the separate version 1.0 draft still selected build 5. No build 7 physical installation or push-delivery pass is claimed.

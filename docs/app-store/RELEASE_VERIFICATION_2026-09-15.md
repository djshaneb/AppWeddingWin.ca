...
The current screenshot fixture cannot provide a full functional draw review: test participation is excluded from authenticated result delivery, as well as real prize notices. An isolated, explicitly nonbinding review mode with controlled test notifications and a new native build has been proposed for owner approval. It has not been implemented or deployed. Existing fixture guards and production draw rules remain unchanged.

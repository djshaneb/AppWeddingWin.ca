...
- [ ] Real Sign in with Apple, including Hide My Email, returning-user flow, one-time website app-login exchange, and production rejection of Expo Go's shared audience (`ALLOW_EXPO_GO_APPLE_AUD` unset/disabled).

...
export const WEBSITE_COUPLE_ACTIONS = ["fixture_context", "scan", "raffle_offer", "raffle_opt_in", "contact_profile_get", "contact_profile_save", "participation_accept"] as const;
